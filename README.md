...
*TIP:* if you are a Spring Boot user and wish your JSON output to pretty printed during sample generation, set the `jackson.serialization.indent_output` property to true when you run your tests.  Here is an example snippet from an `application.yml` file:
