...
public abstract class CookieDocumentation {
	 ...
	 * @see #cookieWithName(String)
	 */
	public static RequestCookiesSnippet requestCookies(
	 ...
	 * @see #cookieWithName(String)
	 */
	public static RequestCookiesSnippet relaxedRequestCookies(
			Map<String, Object> attributes, List<CookieDescriptor> descriptors) {
	 ...
	 * @see #cookieWithName(String)
	 */
	public static ResponseCookiesSnippet responseCookies(
			CookieDescriptor... descriptors) {
	 ...
	 * @see #cookieWithName(String)
	 */
	public static ResponseCookiesSnippet relaxedResponseCookies(
			List<CookieDescriptor> descriptors) {
