...
See the xref:configuration.adoc[configuration section] for more information.
...
See xref:documenting-your-api.adoc[] for more information about these and other snippets that can be produced by Spring REST Docs.
