...
[[documenting-your-api.request-part-payloads]]
...
[[documenting-your-api.request-part-payloads.body]]
...
[[documenting-your-api.request-part-payloads.fields]]
...
See the xref:configuration.adoc#configuration.default-snippets[configuration section] for more information.



[[documenting-your-api.parameterized-output-directories]]
