...
TIP: If you use MockMvc or a WebTestClient that is not bound to a server, you should customize URIs by xref:configuration/uris.adoc#configuration.uris[changing the configuration].
